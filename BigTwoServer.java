...
public class BigTwoServer implements CardGame {
    ...
    public void start(Deck deck) {
        ...
        // call the repaint() method show the cards on the table
        repaint();
        // call the promptActivePlayer() method to prompt user to select cards and make his/her move
    ...
    private void promptActivePlayer(int playerIdx, int size){
    ...
    private void checkMoveMessage(String msg){
